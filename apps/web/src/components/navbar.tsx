  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 flex justify-center p-3 md:p-6 pointer-events-none">
      <div ref={menuShellRef} className="relative w-full max-w-5xl pointer-events-none">
        <div className="pointer-events-auto relative flex h-12 w-full items-center justify-between rounded-xl border border-white/10 bg-black/55 px-3 shadow-2xl backdrop-blur-2xl md:h-14 md:px-6">
