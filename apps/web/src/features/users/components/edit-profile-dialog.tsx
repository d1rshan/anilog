...
export function EditProfileDialog({ user, isOpen, onOpenChange, onSuccess }: EditProfileDialogProps) {
  ...
  return (
    <CustomDialog open={isOpen} onOpenChange={onOpenChange}>
      <CustomDialogContent className="flex max-h-[88svh] w-full max-w-[calc(100%-1.5rem)] flex-col overflow-hidden border border-white/10 bg-black p-0 text-white shadow-2xl sm:max-w-4xl">
        <CustomDialogHeader className="space-y-2 border-b border-white/10 p-8 pb-6 text-left">
        ...
        <CustomDialogFooter className="border-t border-white/10 p-8 pt-6">
          <Button
            variant="ghost"
