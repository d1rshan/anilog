...
export const UsersPage = async () => {
  return (
    <div className="container mx-auto overflow-x-clip px-4 pb-20 pt-24 md:py-32">
      <div className="mb-12 space-y-4 text-center md:mb-24">
        <h1 className="font-display text-5xl font-extrabold uppercase leading-[0.82] tracking-tight text-foreground sm:text-7xl md:text-[13vw]">
          COMMUNITY
        </h1>
